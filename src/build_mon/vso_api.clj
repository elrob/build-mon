...
(defn- retrieve-commit-message [get-fn account build]
...
(defn- retrieve-last-two-builds [get-fn account project build-definition-id]
...
(defn retrieve-build-info [get-fn account project build-definition-id]
  (let [[build previous-build] (retrieve-last-two-builds get-fn account project build-definition-id)
        commit-message (retrieve-commit-message get-fn account build)]
    {:build build
     :previous-build previous-build
     :commit-message commit-message}))

(defn retrieve-build-definitions [get-fn account project]
